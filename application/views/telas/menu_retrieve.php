                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-sm btn-warning" href="<?php echo base_url("menu/editar/$linha->id"); ?>" title=""><i class="fa fa-pencil-square-o"></i></a>
                                    <a class="btn btn-sm btn-danger" onclick="return confirm('Deseja excluir este menu?');" href="<?php echo base_url("menu/excluir/$linha->id"); ?>" title=""><i class="fa fa-trash-o"></i></a>
                                </div>
                                </td>
                            </tr>
                            <?php } ?>
